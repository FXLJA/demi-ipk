...
from app.gann_trainer import ScoreEvaluator
...
class TestGANNTrainer(unittest.TestCase):
    ...
    @patch('app.gann_trainer.GANNTrainer.reproduction')
    @patch('app.gann_trainer.GANNTrainer.selection')
    @patch('app.gann_trainer.GANNTrainer.evaluation')
    ...
    @patch('app.gann_trainer.GANNTrainer._update_test_score')
    @patch('app.gann_trainer.GANNTrainer._update_training_score')
    ...
    @patch('app.gann_trainer.ScoreEvaluator.calc_training_score')
    ...
    @patch('app.gann_trainer.ScoreEvaluator.calc_test_score')
...
class TestScoreEvaluator(unittest.TestCase):
    ...
    @patch('app.gann_trainer.ScoreEvaluator._calc_score')
    ...
    @patch('app.gann_trainer.ScoreEvaluator._calc_gann_score')
...
class TestDatasetScoring(unittest.TestCase):
    ...
    @patch('app.gann_trainer.ScoreEvaluator._calc_gann_dataset_score')
